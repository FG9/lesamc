...
module.exports = {
  ...
  add: async (values) => {
    const data = await Blog.create(_.omit(values, _.keys(_.groupBy(strapi.models.blog.associations, 'alias'))));
    await strapi.hook.mongoose.manageRelations('blog', _.merge(_.clone(data), { values }));
    return data;
  },
